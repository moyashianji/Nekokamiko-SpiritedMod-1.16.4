...
public class NekoRender extends MobRenderer<NekoEntity, NekokamikoModel<NekoEntity>> {

    //テクスチャの場所を指定
    private static final ResourceLocation NEKO_ENTITY = new ResourceLocation("nekokamiko","textures/entity/mob/steve.png");
    ...
    //
    public NekoRender(EntityRendererManager renderManagerIn) {
        super(renderManagerIn, new NekokamikoModel<>(), 0.4F);
    ...
    //
    @Override
    public ResourceLocation getEntityTexture(NekoEntity entity) {
        return NEKO_ENTITY;
    }
    ...
    //
    protected void preRenderCallback(NekoEntity entitylivingbaseIn, MatrixStack matrixStackIn, float partialTickTime) {
